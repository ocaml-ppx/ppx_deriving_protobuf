...
(* OASIS_START *)
(* DO NOT EDIT (digest: cd81d2afa7e2f40bc5601b9ee2e771b4) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_ppx_protobuf", []))];
     ...
     package =
       {
          ...
          homepage = None;
          synopsis =
            "A Protobuf codec generator for OCaml >=4.02 based on extension points";
          description = None;
          categories = [];
                      ...
                      bs_byteopt =
                        [
                           (OASISExpr.EBool true,
                             ["-ppx"; "ocamlfind ppx_tools/ppx_metaquot"])
                        ];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {exec_custom = false; exec_main_is = "ppx_protobuf.ml"});
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "protobuf";
                           FindlibPackage
                             ("oUnit", Some (OASISVersion.VGreaterEqual "2"));
                           FindlibPackage
                             ("uint",
                      ...
                      bs_build_tools =
                        [
                           ...
                           InternalExecutable "ppx_protobuf"
                        ];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                      ...
                      bs_byteopt =
                        [
                           (OASISExpr.EBool true,
                             ["-ppx"; "lib/ppx_protobuf.byte"])
                        ];
                      bs_nativeopt = [(OASISExpr.EBool true, [])]
                   },
                   {
                      exec_custom = false;
                      exec_main_is = "test_ppx_protobuf.ml"
                   });
               Test
                 ({
                     cs_name = "test_ppx_protobuf";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\207\197\148.\231V\217\1654x\182\233}'\168\209";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
